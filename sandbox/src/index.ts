...
fakeClient.fake(table)
window.Input.send("wybierz paczke 3")
fakeClient.fake("Pracownik poczty przekazuje ci jakas paczke.")


fakeClient.fake(" ")
fakeClient.fake("Ciosem ciezkiego bojowego topora w korpus zadajesz umiesnionemu zgarbionemu goblinowi nieduza rane i uderzeniem okraglej drewnianej tarczy odpychasz w tyl.", "combat.avatar")
fakeClient.fake(" ")
fakeClient.fake("Dlugoreki oglupialy ghoul probuje cie trafic pozolklymi paznokciami, lecz tobie udaje sie uniknac tego ciosu.", "combat.avatar")
fakeClient.fake(" ")

fakeClient.fake("Zatrzymujesz atak brzydkiego zgarbionego goblina pewnym blokiem okraglej drewnianej tarczy i poteznym ciosem ciezkiego bojowego topora powaznie ranisz mu korpus.", "combat.avatar");
